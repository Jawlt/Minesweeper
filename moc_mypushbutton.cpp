...
QT_MOC_LITERAL(1, 13, 22), // "customRightClickSignal"
QT_MOC_LITERAL(2, 36, 0) // ""

    },
    "MyPushButton\0customRightClickSignal\0"
    ""
};
...
void MyPushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->customRightClickSignal(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyPushButton::customRightClickSignal)) {
                *result = 0;
                return;
            }
        }
